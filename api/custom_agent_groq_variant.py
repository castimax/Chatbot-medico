"""
Variant agent logic using ChatGroq and specific tools.

This module provides functions to create and run a Langchain agent
configured with ChatGroq LLM and tools including Wikipedia, Arxiv,
a Mayo Clinic web scraper, and a ClinVar API fetcher.
It's designed to be potentially used by `main_variant_ollama.py`.
"""
import os
import json
